...
const MOOD_KEYWORDS = {
  ...
  Adventure:    ["adventure", "explore", "exploring", "travel", "road trip", "journey", "discover", "wild", "free", "open"],
  Sleepy:       ["sleepy", "sleep", "tired", "exhausted", "drowsy", "night", "bed", "rest", "nap", "dreamy", "bedtime"],
  Groovy:       ["groovy", "groove", "funky", "funk", "soul", "smooth", "rhythm", "bass", "swing", "vibe"],
  Workout:      ["workout", "gym", "exercise", "training", "run", "running", "lift", "cardio", "sport", "sweat", "fit"],
};
